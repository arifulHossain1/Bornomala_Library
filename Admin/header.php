<?php
    ...
    $data = mysqli_query($con,"SELECT * FROM `ladmin` WHERE `email`='$admin_login'");
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        ...
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($admin_info['firstname']).' '.ucwords($admin_info['lastname'])?></span>
        ...
        <div class="page-body">
            ...
            <div class="left-sidebar">
                ...
                <div class="left-sidebar-header">
                    <div class="left-sidebar-title">Admin Navigation</div>
