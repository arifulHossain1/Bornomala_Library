<?php
    ...
    $data = mysqli_query($con,"SELECT * FROM `user` WHERE `email`='$user_login'");
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="../assets/images/avatar/My Photo.jpg" />
                        </div>
                        <div class="user-info">
                            <span class="user-name"><?= ucwords($user_info['fname']).' '.ucwords($user_info['lname'])?></span>
        ...
        <div class="page-body">
            ...
            <div class="left-sidebar">
                ...
                <div class="left-sidebar-header">
                    <div class="left-sidebar-title">User Navigation</div>
